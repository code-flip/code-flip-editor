...
class Workspace implements Renderable {
  render(parent: SVGGElement | SVGElement): void {
    ...
    this.bBox = new Rectangle(this.editor.toolbox.bBox.width, 0, this.editor.container.clientWidth - this.editor.toolbox.bBox.width, this.editor.container.clientHeight);
  ...
  constructor(editor: CodeFlip) {
    ...
    this.bBox = new Rectangle(500, 0, 500, 500);
  }
}
export { Workspace };
